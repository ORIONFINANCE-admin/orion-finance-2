...
║                    ╰───────✦───────╯                                ║
║                                                                      ║
║                  REGISTRAR • COMPREENDER • EVOLUIR                  ║
║                                                                      ║
╚══════════════════════════════════════════════════════════════════════╝


ORION FINANCE 2.0
Versão do aplicativo: 0.5.3
Estrutura do banco: 1.5.1
...
CAJU ALIMENTAÇÃO
    ...
    • reduz diretamente o saldo do benefício;
    • não gera fatura;
    • não interfere em outra conta;
    • previsão de R$ 400 no primeiro dia útil do mês;
    • o lançamento mensal exige confirmação.

CAJU SALDO LIVRE
    • recebe premiações;
    • saldo independente;
    • permite transferência para conta corrente.

Transferências não são contabilizadas como renda nem como despesa.
...
O reset exige confirmação digitando:
