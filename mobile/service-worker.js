const CACHE = 'orion-v0-2-4-pwa-dock-safearea-repair';
const SHELL = [
  './',
  './index.html',
  './orion-v0204.css',
  './orion-v0204.js',
  '../manifest.webmanifest?v=0204',
  '../assets/orion-icon-v0101.png',
  '../assets/apple-touch-icon-v0101.png',
  '../assets/icon-192-v0101.png',
  '../assets/icon-512-v0101.png',
