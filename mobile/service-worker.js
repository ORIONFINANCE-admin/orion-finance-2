const CACHE = 'orion-v0-3-5-local-only';
const SHELL = [
  './',
  './index.html',
  './orion.css?v=0306',
  './orion.js?v=0306',
  './manifest.webmanifest?v=0306',
  '../assets/orion-icon-v035.png',
  '../assets/apple-touch-icon-v035.png',
  '../assets/icon-192-v035.png',
  '../assets/icon-512-v035.png'
];
