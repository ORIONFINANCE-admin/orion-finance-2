...
const BUILD_ID="2026-08-17.2014";
...
$("themeSelect").addEventListener("change",()=>saveSettings({theme:$("themeSelect").value}));$("animationsToggle").addEventListener("change",()=>saveSettings({animations:$("animationsToggle").checked}));$("hideValuesToggle").addEventListener("change",()=>saveSettings({hideValues:$("hideValuesToggle").checked}));$("localProfileName")?.addEventListener("change",()=>saveSettings({profileName:$("localProfileName").value}));$("syncSettingsBtn").addEventListener("click",performSync);
