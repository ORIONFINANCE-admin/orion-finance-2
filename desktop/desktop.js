...
const BUILD_ID="2026-08-15.2305";
...
document.querySelectorAll("[data-brand-option]").forEach(btn=>btn.addEventListener("click",()=>{const next=saveSettings({brandStyle:btn.dataset.brandOption});applyBrand(next.brandStyle);renderBrandPicker(next);toast("Identidade visual atualizada.");}));
