...
$("themeSelect").addEventListener("change",()=>saveSettings({theme:$("themeSelect").value}));$("animationsToggle").addEventListener("change",()=>saveSettings({animations:$("animationsToggle").checked}));$("hideValuesToggle").addEventListener("change",()=>saveSettings({hideValues:$("hideValuesToggle").checked}));$("localProfileName")?.addEventListener("change",()=>{const s=saveSettings({profileName:$("localProfileName").value});applyLocalProfile(s.profileName);});$("syncSettingsBtn").addEventListener("click",performSync);
