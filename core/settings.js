...
const DEFAULTS = Object.freeze({ theme:"system", animations:true, hideValues:false });
...
export function applySettings(settings=getSettings()){
  ...
  const root=document.documentElement; root.dataset.theme=dark?"dark":"light"; root.dataset.animations=settings.animations?"on":"off"; root.dataset.hideValues=settings.hideValues?"on":"off"; return settings;
}
