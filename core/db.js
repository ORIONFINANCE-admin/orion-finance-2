...
export const STORE_MAP = Object.freeze({
  ...
  EVENTOS: { store: "eventos", key: "evento_id" },
  EVENTO_RESERVAS: { store: "evento_reservas", key: "reserva_evento_id" },
  PERFIS: { store: "perfis", key: "perfil_id" },
  ALOCACOES: { store: "alocacoes", key: "alocacao_id" },
  MOVIMENTOS_ALOCACAO: { store: "movimentos_alocacao", key: "movimento_alocacao_id" }
});
